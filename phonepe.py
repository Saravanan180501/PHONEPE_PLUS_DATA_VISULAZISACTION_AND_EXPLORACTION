...
def Aggre_user_plot_2(df, quarter):
    ...
    fig_bar_1=px.bar(aguyqg, x="Brands", y="Transaction_count", title=f"{quarter} QUARTER, BRANDS AND TRANSACTION COUNT",
                        width=1000,color_discrete_sequence=px.colors.sequential.dense_r ,hover_name="Brands")
    st.plotly_chart(fig_bar_1)
...
def map_user_plot_3(df,states):
    ...
    with col1:
        fig_map_user_bar_1=px.bar(muyqs, x="RegisteredUsers", y="Districts", orientation="h",
                                    title= f"{states.upper()}REGISTERED USER",height=800, color_discrete_sequence= px.colors.sequential.solar)
...
def top_insurance_plot_1(df,state):
    ...
    with col1:
        fig_top_insur_bar_1=px.bar(tiy, x="Quarter", y="Transaction_amount",hover_data="Pincodes",
                                        title= "TRANSACTION AMOUNT",height=650,width=600, color_discrete_sequence= px.colors.sequential.PuBuGn_r)
...
if select=="HOME":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\Admin\OneDrive\Desktop\phonepe\download.png"),width=600)
    
    col3,col4= st.columns(2)
    
    with col3:
        st.video(r'C:\Users\Admin\OneDrive\Desktop\phonepe\PhonePe Motion Graphics in After Effects - Naveen Shiva Sai - Student Works.mp4')
    with col4:
    ...
    with col6:
        st.image(Image.open(r"C:\Users\Admin\OneDrive\Desktop\phonepe\images.jpeg"),width=600)
    ...
    with tab2:
        ...
        if method2 =="Map Insurance":
            ...
            with col1:
                ...
                quarter=st.slider("Select The QUARTER_MI",Map_insur_tac_Y["Quarter"].min(),Map_insur_tac_Y["Quarter"].max(),Map_insur_tac_Y["Quarter"].min())
            ...
            with col1:
                ...
                quarter=st.slider("Select The QUARTER_MT",Map_tran_tac_Y["Quarter"].min(),Map_tran_tac_Y["Quarter"].max(),Map_tran_tac_Y["Quarter"].min())
            ...
            with col1:
                ...
                quarter=st.slider("Select The QUARTER_MU",map_user_Y["Quarter"].min(),map_user_Y["Quarter"].max(),map_user_Y["Quarter"].min())
    ...
    question=st.selectbox("Select the Question",["1.Transaction Amount and Count of Aggregated Insurance",
                                                 ...
                                                 "3.Transaction Amount and Count of Top Map Insurance",
                                                 ...
                                                 "11.Top and Last Brands Of Mobile Used"]) 
    ...
    elif question == "3.Transaction Amount and Count of Top Map Insurance":
    ...
    elif question == "11.Top and Last Brands Of Mobile Used":
